...
public class BottomDialog extends android.support.design.widget.BottomSheetDialogFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(builder.direction == RTL ? R.layout.bottom_dialog_rtl : R.layout.bottom_dialog_ltr, container, false);
        try {
            ...
            if (builder.hiddenHeader) {
                ...
                if (builder.titleTextSize != null) {
                    title.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(builder.titleTextSize));
                }
            }
            ...
            if (builder.contentTextSize != null) {
                content.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(builder.contentTextSize));
            }
            ...
            if (builder.positiveTextColorResId != null) {
                positiveBtn.setTextColor(ContextCompat.getColor(getContext(), builder.positiveTextColorResId));
            }
            ...
            if (builder.hiddenNegativeButton) {
                ...
                if (builder.negativeTextColorResId != null) {
                    negativeBtn.setTextColor(ContextCompat.getColor(getContext(), builder.negativeTextColorResId));
                }
    ...
    public void show(Fragment fragment) {
        if (this.isDismissed) return;
        super.show(fragment.getFragmentManager(), "");
    }
